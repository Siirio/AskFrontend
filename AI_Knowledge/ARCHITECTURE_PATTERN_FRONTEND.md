...
Ask_Frontend/                    # ONE Next.js app: marketing at `/`, platform at `/app/*` (D6)
  ...
  src/
    app/                         # Next.js App Router = the composition root (R3).
      ...
      demo/page.tsx              #   /demo → the DESIGN LAB (D24). Not a product surface, not marketing,
                                 #     not gated: noindex, outside BOTH (marketing) and /app/*  [static]
