...
Three CLEAN fixtures (`src/catalog/index.ts`, `src/auth/index.ts`,
`src/auth/ui/legal-relative-import.ts`) must produce zero errors — proving
same-slice internals, door imports, and a within-slice relative `../` stay legal.
